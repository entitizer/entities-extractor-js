...
exports.sortEntities = function(entities) {
	return _.sortBy(entities, function(item) {
		return _.min(item.concepts, 'index').index;
	});
};
...
exports.findSplitedConcepts = function(entities, unknownConcepts) {
	...
	var foundedConcepts = [];
	unknownConcepts = unknownConcepts.filter(function(concept) {
